...
import EmpresasPage, { EMPRESAS } from "../empresas/EmpresasPage";
import ComingSoonFeature from "../../components/shared/ComingSoonFeature";
import {
  T,
  Button,
  Badge,
...
/* ================================================================================
   ...
   Enquanto só a trilha Empresas está em desenvolvimento ativo, as demais
   (já implementadas abaixo, código intacto) são redirecionadas para uma tela
   de "em breve" — ver ComingSoonFeature. Para liberar uma trilha basta remover
   a chave correspondente deste mapa; nenhum outro código precisa mudar.
   ================================================================================ */
const TRILHAS_EM_BREVE = {
  regras: {
    title: "Regras Gerais",
    description: "Esta trilha está em evolução e será disponibilizada nas próximas entregas. Estamos refinando as funcionalidades juntamente com Produto e Operação para garantir a melhor experiência.",
  },
  "regras-trilha-fiscal": {
    title: "Fiscal",
    description: "Esta trilha está em evolução e será disponibilizada nas próximas entregas. Estamos refinando as funcionalidades juntamente com Produto e Operação para garantir a melhor experiência.",
  },
  "regras-trilha-dp": {
...
export default function AutopilotRegras() {
  ...
  const [empresasCrumb, setEmpresasCrumb] = useState("empresas");
    ...
    <div className="flex h-screen w-full overflow-hidden text-sm" style={{ background: T.muted, color: T.foreground, fontFamily: "Inter, sans-serif" }}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {/* ============ EMPRESAS ============ */}
          <div className={section === "empresas" ? "" : "hidden"}>
            <EmpresasPage onCrumbChange={setEmpresasCrumb} />
          </div>

          {/* ============ TRILHAS AINDA NÃO LIBERADAS — ver TRILHAS_EM_BREVE ============ */}
          {TRILHAS_EM_BREVE[section] && <ComingSoonFeature {...TRILHAS_EM_BREVE[section]} />}

          {!TRILHAS_EM_BREVE[section] && (
          <>
          {/* ============ REGRAS GERAIS ============ */}
